...
export const IRONMAN_703_RACES = [
  usRace({ id: "im703-dallas-little-elm", name: "IRONMAN 70.3 Dallas-Little Elm", sport: "ironman-703", date: "2026-03-15", dateLabel: "March 15, 2026", city: "Little Elm", state: "TX", distanceLabel: "70.3 mi (1.2mi swim / 56mi bike / 13.1mi run)", officialUrl: "https://www.ironman.com/im703-dallas", profileStatus: "directory-only" }),
  ...
  usRace({ id: "im703-rockford-illinois", name: "IRONMAN 70.3 Rockford-Illinois", sport: "ironman-703", date: "2026-06-14", dateLabel: "June 14, 2026", city: "Rockford", state: "IL", distanceLabel: "70.3 mi (1.2mi swim / 56mi bike / 13.1mi run)", officialUrl: "https://www.ironman.com/im703-rockford", profileStatus: "directory-only" }),
  ...
  usRace({ id: "im703-new-mexico", name: "IRONMAN 70.3 New Mexico – Ruidoso", sport: "ironman-703", date: "2026-07-12", dateLabel: "July 12, 2026", city: "Ruidoso", state: "NM", distanceLabel: "70.3 mi (1.2mi swim / 56mi bike / 13.1mi run)", officialUrl: "https://www.ironman.com/im703-new-mexico", profileStatus: "directory-only" }),
...
export const ULTRA_RACES = [
  ...
  {
    id: "vermont-100", name: "Vermont 100 Endurance Race", sport: "ultra", date: "2026-07-17", dateLabel: "July 17, 2026",
    city: "West Windsor", state: "VT", country: "USA", region: "Northeast",
    distanceLabel: "100 mi", officialUrl: "https://vermont100.com/",
    profileStatus: "directory-only",
  ...
  {
    id: "hurt-100", name: "HURT 100 (Hawaiian Ultra Running Team)", sport: "ultra", date: "2027-01", dateLabel: "Mid-January (2026 edition ran Jan 18, 2026 — 2027 date TBA)",
    city: "Honolulu (Oahu)", state: "HI", country: "USA", region: "West",
    distanceLabel: "100 mi, ~24,600 ft gain (5 laps)", officialUrl: "https://hurt100.com/",
    profileStatus: "directory-only",
    note: "Capped at 135 runners. Dense tropical single-track with roughly 20 stream crossings per loop.",
  },
  {
